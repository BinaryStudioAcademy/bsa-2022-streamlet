...
import { matchOverviewChartTabWithTitle, matchOverviewChartTabWithValueFunc, OverviewChartTab } from './config';
      ...
      <div className={styles['blocks-body']}>
        ...
        <div className={styles['langs-block']}>
          ...
          <div className={styles['langs-block-table']}>
            ...
            {langData.data.slice(0, 5).map((lg) => (
        ...
        <div className={styles['device-block']}>
          ...
          <CustomPieChart data={deviceData} />
        </div>
      </div>
    </div>
  );
