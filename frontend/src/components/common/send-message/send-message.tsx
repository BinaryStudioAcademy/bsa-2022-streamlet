...
const SendMessage: FC = () => {
  return (
    <div className="add-comments">
      <input className="input-add-comments" type="text" placeholder="Add comments" />
      <div className="group-buttons-reactions">
        <button className="choose-emoji">
        ...
        <button className="send-message">
          <svg width="24" height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 20.2105V12.4737L9.53684 10.1053L0 7.67368V0L24 10.1053L0 20.2105Z" fill="white" />
          </svg>
        </button>
      </div>
    </div>
