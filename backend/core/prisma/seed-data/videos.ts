...
const videosNoChannels: Omit<Video, 'updatedAt' | 'createdAt' | 'channelId' | 'publishedAt' | 'scheduledStreamDate'>[] =
  [
    ...
    {
      'id': 'e7b87234-4fde-4209-9111-12dfs34b08f5',
      'name': 'New channel',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
    ...
    {
      'id': 'k4p11234-4fde-4209-9111-12dfs34b08f5',
      'name': 'Hello world',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
    ...
    {
      'id': 'b0b87234-4fde-4209-9111-23dxz34b08f5',
      'name': 'Very important channel',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
      'privacy': 'PUBLIC',
    ...
    {
      'id': 'e7b809878-8fff-0079-9111-12dfs34b08f5',
      'name': 'Marko Paulo',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
    ...
    {
      'id': 'p2m87234-4fde-4209-0001-12bfs11p08f5',
      'name': 'My first blog',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
    ...
    {
      'id': 'm3m87234-4fde-4209-9111-12dfs34b08f5',
    ...
    {
      'id': 's0a87234-4fd6-7601-9111-12dfs34b08f5',
      'name': 'Math channel',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
    ...
    {
      'id': 'k1k11221-4fde-4209-9111-12dfs34b08f5',
      'name': 'Good story',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
    ...
    {
      'id': 'm4e87372-4fer-4209-9111-12dfs24b90f5',
      'name': 'My new video',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
    ...
    {
      'id': 'e7b85554-4fde-4209-9312-12dkl34l48f5',
      'name': 'How i can do this?',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
      'privacy': 'PUBLIC',
    ...
    {
      'id': 'e7b87234-4fde-4209-9111-12dfs34o1of5',
      'name': 'New video',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
    ...
    {
      'id': 'e7b88987-4ess-4444-9333-27jpi34b08f5',
      'name': 'Good story',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
    ...
    {
      'id': 'j5j87234-4fde-5189-9123-12dfs34b08f5',
    ...
    {
      'id': 'o4g87223-4gge-4209-9111-12dfs34b08f5',
      'name': 'Happy new year',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
    ...
    {
      'id': 'g4o07584-4fde-4209-9111-12dfs34b08f5',
      'name': 'New story',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
    ...
    {
      'id': 'g4o02009-4ghe-4209-9111-12dfs34b08f5',
      'name': 'Its my new bike',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
      'privacy': 'PUBLIC',
    ...
    {
      'id': 'g4o02119-4ghj-42fg-9111-12dfs34b08f5',
      'name': 'Its my old bike',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
      'privacy': 'PUBLIC',
    ...
    {
      'id': 'g4o02675-4rhe-4225-9111-12dfs34b08f5',
      'name': 'Top gear program',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
      'privacy': 'PUBLIC',
    ...
    {
      'id': 'g4h08709-4ghe-4209-9111-12drr34b08f5',
      'name': 'Feigin live',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
    ...
    {
      'id': 'y4o0287-4ghe-4209-9111-12dyy34b08f5',
      'name': 'Vasya and Petia',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
      'privacy': 'PUBLIC',
    ...
    {
      'id': 'g4o1254-4gyy-4233-9771-12dty34b08f5',
      'name': 'Biba and Boba',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
    ...
    {
      'id': 'g4uer09-4rte-4209-9561-12dfs34b08tt',
      'name': 'Record timeout',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
    ...
    {
      'id': 'p6y02009-4ghe-4209-9111-12dfs34b08f5',
      'name': 'How much cost your stuff?',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
      'privacy': 'PUBLIC',
    ...
    {
      'id': 'g4o02339-4the-4y09-9111-12dfs34b08f5',
      'name': 'Its better idea',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
      'privacy': 'PUBLIC',
    ...
    {
      'id': 'u8i02009-4ghe-4209-9111-12dfs34b08f5',
      'name': 'Media studio record',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
      'privacy': 'PUBLIC',
    ...
    {
      'id': 'i9u0275-4ghe-4209-9111-12dfs34b08f5',
      'name': 'IQOS or Vape?',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
    ...
    {
      'id': 'y7e02329-4grt-4279-9111-12dfs34b08f5',
      'name': 'BMW or Mercedes?',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
      'privacy': 'PUBLIC',
    ...
    {
      'id': 'g4o02009-4grt-4999-9662-12dui34b08q5',
      'name': 'Every day I ...',
      'description': 'Find out more about our academy',
      'status': 'FINISHED',
      'isReadyToStream': false,
